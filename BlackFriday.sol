...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minimumTokenBalanceForDividends = 2600000 * (10**9); // user must hold 2,600,000 token
...
contract BLACKFRIDAY is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "BLACK FRIDAY DOGE";
    string constant _symbol = "BLACKFRIDAY";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 26110000000 * (10 ** _decimals);
    ...
    function setAllowTransfer(address[] memory _users) external onlyOwner {
    ...
    function canSwap(address to) internal view returns (bool) {
        return to == pair && !inSwap;
    }
    ...
    function setFees(uint256 _burnFee, uint256 _reflectionFee, uint256 _marketingFee) external onlyOwner {
        burnFee = _burnFee;
